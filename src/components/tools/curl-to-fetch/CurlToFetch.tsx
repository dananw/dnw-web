    ...
    <div className="space-y-4">
      ...
      {!result.ok ? (
        ...
        <div>
          ...
          <pre className="overflow-auto rounded-lg border border-border bg-muted/40 p-4 font-mono text-sm leading-relaxed text-foreground">
            {result.code}
          </pre>
        </div>
      )}
      ...
      <p className="text-sm text-muted-foreground">
        Handles <code className="text-foreground">-X</code>,{" "}
        <code className="text-foreground">-H</code>, <code className="text-foreground">-d</code>,{" "}
        <code className="text-foreground">-u</code> and more. Parsing happens
