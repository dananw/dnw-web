...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    tagline: "Convert curl commands to fetch().",
    category: "dev",
    tags: ["curl", "fetch", "http"],
    icon: "Terminal",
    published: true,
  },
  {
    ...
    description:
      "Generate the current time-based one-time password from a Base32 secret, just like an authenticator app.",
    tagline: "Live 2FA codes from a secret.",
    category: "dev",
    tags: ["totp", "2fa", "otp"],
    icon: "Smartphone",
    published: true,
  },
  {
    ...
    tagline: "Inline images as data URIs.",
    category: "dev",
  ...
  },
  {
    ...
    title: "File Hash",
    description:
      "Compute SHA-1, SHA-256, SHA-384 and SHA-512 checksums of any file locally with the Web Crypto API.",
    tagline: "Checksum files in your browser.",
    category: "dev",
    tags: ["hash", "checksum", "file"],
    icon: "FileCheck2",
    published: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "Search file extensions and their MIME types in both directions, from a built-in reference.",
    tagline: "Extensions ↔ MIME types.",
    category: "dev",
    tags: ["mime", "content-type", "reference"],
    icon: "FileSearch",
    published: true,
  },
  {
    ...
    title: "Common Ports",
    description:
      "Look up well-known TCP/UDP port numbers and the services that use them.",
    tagline: "What runs on which port?",
    category: "dev",
    tags: ["ports", "network", "reference"],
    icon: "Plug",
    published: true,
  },
  {
    ...
    description:
      "Convert text to and from RFC 4648 Base32, the encoding used by TOTP secrets and more.",
    tagline: "Text ↔ Base32.",
    category: "dev",
  ...
  },
  {
    ...
    tagline: "Structural diff for JSON.",
    category: "dev",
  ...
  },
  {
    ...
    title: "SQL Formatter",
    description:
      "Format and indent SQL queries, uppercasing keywords and breaking clauses onto their own lines.",
    tagline: "Tidy up SQL queries.",
    category: "format",
  ...
  },
  {
    ...
    description:
      "Break text into characters and inspect each code point, hex, HTML entity and UTF-8 bytes.",
    tagline: "Inspect every code point.",
    category: "text",
  ...
  },
  {
    ...
    description:
      "Turn plain text into Unicode styles — bold, italic, script, monospace and more — for social bios.",
    tagline: "𝐁𝐨𝐥𝐝 & 𝓯𝓪𝓷𝓬𝔂 Unicode text.",
    category: "text",
    tags: ["unicode", "fancy", "fonts"],
    icon: "Wand2",
    published: true,
  },
  {
    ...
    description:
      "Calculate the specificity of a CSS selector, broken down into IDs, classes and elements.",
    tagline: "Score any CSS selector.",
    category: "design",
  ...
  },
  {
    ...
    title: "Color Mixer",
    description:
      "Blend two colors at any ratio and read off the resulting HEX and RGB values.",
    tagline: "Mix two colors by ratio.",
    category: "design",
  ...
  },
  {
    ...
    description:
      "Generate complementary, analogous, triadic and tetradic palettes from a single base color.",
    tagline: "Build a palette from one color.",
    category: "design",
  ...
  },
  {
    ...
    description:
      "Find the nearest named CSS color to any HEX value, with the exact match flagged.",
    tagline: "HEX to the closest color name.",
    category: "design",
    tags: ["color", "name", "css"],
    icon: "PaintBucket",
    published: true,
  },
  {
    ...
    tagline: "Visualize flexbox properties.",
    category: "design",
  ...
  },
  {
    ...
    tagline: "Design CSS grid templates.",
    category: "design",
  ...
  },
  {
    ...
    description:
      "Convert a date and time across time zones using your browser's built-in IANA database.",
    tagline: "Compare a time across zones.",
    category: "misc",
  ...
  },
  {
    ...
    description:
      "Compute nPr and nCr for any n and r using big integers, so large counts stay exact.",
    tagline: "nPr and nCr, exactly.",
    category: "misc",
    tags: ["combinatorics", "math", "factorial"],
    icon: "Combine",
    published: true,
  },
  {
    ...
    description:
      "Project savings growth from a principal, rate, compounding frequency and optional contributions.",
    tagline: "Watch compounding add up.",
    category: "misc",
  ...
  },
  {
    ...
    description:
      "Measure the time between two dates and times, broken down into days, hours, minutes and seconds.",
    tagline: "Time between two moments.",
    category: "misc",
    tags: ["duration", "time", "difference"],
    icon: "Hourglass",
    published: true,
  },
  {
    ...
    description:
      "Turn any text or URL into a QR code you can download as SVG, with adjustable size and error correction.",
    tagline: "Make a QR code from text.",
    category: "misc",
